	...
	<main>
		...
		<section id="main-section">
			<div class="d-flex justify-content-center my-5" id="search-bar">
				<div class="search-container">
					<div class="search-wrapper">
						...
						</select> <input type="text" id="search-keyword" class="form-control"
							placeholder="검색어를 입력하세요" aria-label="검색" autocomplete="off" />
			...
			<div class="d-flex justify-content-center mb-4">
				<div class="btn-group" role="group">
					<button class="btn btn-outline-secondary" id="iScore" type="button"
						data-sortIscore="1">아이난이도</button>
					<button class="btn btn-outline-secondary" id="placeVerified"
						type="button" data-sortPlaceVerified="1">방문횟수</button>
					<button class="btn btn-outline-secondary" id="userFavorite"
						type="button" data-sortUserFavorite="1">좋아요</button>
					<button class="btn btn-outline-secondary" id="reviewCnt"
						type="button" data-sortReviewCnt="1">리뷰수</button>
				</div>
			</div>
			...
			<div class="container-fluid main-container" id="container">
				<div class="row text-center" id="cardMain">
					...
					<c:forEach var="place" items="${placesInfo}" varStatus="status">
						<div
							class="col-lg-4 col-md-6 mb-3 card-item ${status.index > 5 ? 'd-none extra-card' : ''}">
							<div class="main-card go-to-details"
								...
								<div class="main-card-header bg-transparent">
									<div class="d-flex justify-content-between align-items-center">
										...
										<i
											class="bi ${place.userFavorite == 1 ? 'bi-heart-fill red-color' : 'bi-heart'} main-custom-heart"
											data-place-name="${place.placeName}"
											data-user-favorite="${place.userFavorite}"></i>
									</div>
									<div class="main-badges mt-3">
										<span class="badge"><i class="bi bi-fire" id="fire"></i>
											${place.highestBadge}</span> <span class="badge"><i
											class="bi bi-fire" id="fire"></i> ${place.secondHighestBadge}</span>
										<span class="badge difficulty-badge"
											data-iscore="${place.IScore}">아이난이도: ${place.IScore}</span>
									</div>
								</div>
								...
								<div class="main-card-body">
									<img src="${place.firstUrl}" alt="${place.placeName}"
										class="img-fluid mb-2" /> <img src="${place.secondUrl}"
										alt="${place.placeName}" class="img-fluid mb-2" /> <img
										src="${place.thirdUrl}" alt="${place.placeName}"
								...
								<div class="main-card-footer bg-transparent">
									<div class="footer-meta">
										...
										<div class="post-info">
											<fmt:parseDate value="${ place.modifiedAt }"
												pattern="yyyy-MM-dd" var="parsedDateTime" type="both" />
											<span class="date"><i class="bi bi-calendar3"></i> <fmt:formatDate
													pattern="yyyy-MM-dd" value="${parsedDateTime}" /></span> <span
												class="likes"><i class="bi bi-heart-fill"></i>
												${place.likeCount}</span>
										</div>
									</div>
									<div class="comment-section">
										<p class="comment-text">
											<i class="bi bi-chat-left-quote"></i> ${place.review}
										</p>
									</div>
								</div>
							</div>
			...
			<div class="gallery-body">
				<div class="gallery-content-container">
					<div class="gallery-box">
						<span style="--i: 0"> <img />
						</span> <span style="--i: 1"> <img />
						</span> <span style="--i: 2"> <img />
						</span> <span style="--i: 3"> <img />
						</span> <span style="--i: 4"> <img />
						</span> <span style="--i: 5"> <img />
						</span> <span style="--i: 6"> <img />
						</span> <span style="--i: 7"> <img />
						</span>
					</div>
		...
		<section id="lotto-section" class="lotto-body">
			<div class="lotto-container">
				...
				<div id="points" name="points">
					남은 포인트 : <span class="points"><fmt:formatNumber
							value="${points}" type="number" groupingUsed="true" /></span> P
				</div>
				...
				<c:forEach var="faq" items="${faqList}" varStatus="status">
					<div class="accordion-item">
						<h2 class="accordion-header">
							<button
								class="accordion-button ${status.index == 0 ? '' : 'collapsed'}"

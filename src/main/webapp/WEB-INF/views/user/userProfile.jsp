...
<body>
	...
	<main style="margin-top: 120px; margin-bottom: 15%;"
				...
				<div class="col-md-3 sidebar">
					<div class="profile-summary">
						<input type="file" id="profileImageInput" style="display: none"
							...
							id="profileImage" class="rounded-circle profile-img profileImage"
					...
					<nav class="nav flex-column flex-md-column nav-pills"
						id="v-pills-tab" role="tablist">
						<button class="nav-link active flex-sm-fill" id="v-pills-home-tab"
							data-bs-toggle="pill" data-bs-target="#v-pills-home"
							type="button" role="tab">
							<i class="fas fa-user tab-icon me-2"></i>내정보
						</button>
						<button class="nav-link flex-sm-fill" id="v-pills-profile-tab"
							data-bs-toggle="pill" data-bs-target="#v-pills-profile"
							type="button" role="tab">
							<i class="fas fa-edit tab-icon me-2"></i>내정보수정
						</button>
						<button class="nav-link flex-sm-fill" id="v-pills-disabled-tab"
							data-bs-toggle="pill" data-bs-target="#v-pills-disabled"
							type="button" role="tab">
							<i class="fas fa-history tab-icon me-2"></i>내활동내역
						</button>
						<button class="nav-link flex-sm-fill" id="v-pills-messages-tab"
						...
						<div class="tab-pane fade show active" id="v-pills-home"
							...
							<div class="card">
								<div class="card-body">
									...
									<h5 class="card-title mb-0 mt-3">닉네임</h5>
									<p class="card-text" id="userNickName">${ userInfo.nickName }
									</p>
									...
									<p class="card-text" id="cumulativePoint">
										누적 포인트:<span class="cumulativePoints">
											<fmt:formatNumber value="${userInfo.cumulativePoint}"
						...
						<div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
							...
							<div
								...
								<button id="withdrawal" type="button"
									class="btn btn-outline-secondary btn-sm" style="padding: 3px">
									회원탈퇴</button>
							</div>
							<!-- TODO 시작 -->
							<div class="containerImageChange"
								...
								<div class="info infoInImageChangeContainer">
									<p style="opacity: 0.8">98x98픽셀 이상, 10MB 이하의 사진이 권장됩니다. PNG
										또는 GIF(애니메이션 GIF 제외) 파일을 사용하세요. 사진이 Igojoa 커뮤니티 가이드를 준수해야 합니다.
									</p>
									<div class="buttons">
										<button class="btn btn-warning" id="imageChange">
											변경</button>
										<button class="btn btn-danger" id="imageDelete">
											삭제</button>
									</div>
								</div>
							</div>
							...
							<form id="editProfileForm">
								...
								<div class="mb-3">
									<label for="email" class="form-label">이메일
										주소</label> <input type="email" class="form-control" id="email"
								...
								<div class="mb-3">
									...
									<div class="phone-input-container"
										...
										<input type="text" class="form-control phone-input"
											...
											style="width: 60px; text-align: center;" value="${part1}"
											name="phone1" />
										<span>-</span> <input type="text"
											class="form-control phone-input" id="phone2" maxlength="4"
											style="width: 80px; text-align: center;" value="${part2}"
											name="phone2" />
										<span>-</span> <input type="text"
											class="form-control phone-input" id="phone3" maxlength="4"
											style="width: 80px; text-align: center;" value="${part3}"
											name="phone3" />
									</div>
						...
						<div class="tab-pane fade" id="v-pills-disabled" role="tabpanel"
							...
							<div class="search-container">
								<select id="address-select" class="form-select"
									...
									id="search-input" />
								<button type="submit" id="userActivitySearchBtn">
									검색</button>
							</div>
							<div
								...
								<nav class="dateRangeWithNavs">
									<div class="nav nav-tabs" id="nav-tab" role="tablist">
										<button class="nav-link active d-flex" id="nav-total-tab"
											data-bs-toggle="tab" data-bs-target="#nav-total"
											type="button" role="tab" aria-controls="nav-total"
											aria-selected="true">
											전체 내역
											<p>
										...
										<button class="nav-link d-flex" id="nav-favoritePlace-tab"
											data-bs-toggle="tab" data-bs-target="#nav-favoritePlace"
											type="button" role="tab" aria-controls="nav-favoritePlace"
											aria-selected="false">
											좋아요한 게시물
											<p>
												<i class="sort-icon fa-solid fa-sort"></i>
										...
										<button class="nav-link d-flex" id="nav-likedReview-tab"
											data-bs-toggle="tab" data-bs-target="#nav-likedReview"
											type="button" role="tab" aria-controls="nav-likedReview"
											aria-selected="false">
											좋아요한 리뷰
											<p>
												<i class="sort-icon fa-solid fa-sort"></i>
										...
										<button class="nav-link d-flex" id="nav-writtenReview-tab"
											data-bs-toggle="tab" data-bs-target="#nav-writtenReview"
											type="button" role="tab" aria-controls="nav-writtenReview"
											aria-selected="false">
											작성한 리뷰
											<p>
												<i class="sort-icon fa-solid fa-sort"></i>
										...
										<button class="nav-link d-flex" id="nav-verifiedPlace-tab"
											data-bs-toggle="tab" data-bs-target="#nav-verifiedPlace"
											type="button" role="tab" aria-controls="nav-verifiedPlace"
											aria-selected="false">
											위치인증 장소
											<p>
												<i class="sort-icon fa-solid fa-sort ml-2"></i>
											</p>
										</button>
									</div>
								</nav>
							...
							<div class="tab-content" id="nav-tabContent">
								<div class="tab-pane fade show active" id="nav-total"
									role="tabpanel" aria-labelledby="nav-total-tab" tabindex="0">
									<ul class="list-group" id="totalList"></ul>
								</div>
								<div class="tab-pane fade" id="nav-favoritePlace"
									role="tabpanel" aria-labelledby="nav-favoritePlace-tab"
									tabindex="0">
									<ul class="list-group" id="favoritePlaceList"></ul>
								</div>
								<div class="tab-pane fade" id="nav-likedReview" role="tabpanel"
									aria-labelledby="nav-likdedReview-tab" tabindex="0">
									<ul class="list-group" id="likedReviewList"></ul>
								</div>
								<div class="tab-pane fade" id="nav-writtenReview"
									role="tabpanel" aria-labelledby="nav-writtenReview-tab"
									tabindex="0">
									<ul class="list-group" id="writtenReviewList"></ul>
								</div>
								<div class="tab-pane fade" id="nav-verifiedPlace"
									role="tabpanel" aria-labelledby="nav-verifiedPlace-tab"
									tabindex="0">
								...
								<div class="col-md-5 point-summary-container">
									<div class="point-summary mb-3 row">
										<div class="col-md-6 monthly-summary">
											...
											<div>
												<span class="me-3">얻은
													포인트: <span id="monthlyEarnedPoints" class="text-success">0</span>
												</span>
											</div>
											<div>
												<span>소비
													포인트: <span id="monthlySpentPoints" class="text-danger">0</span>
												</span>
											</div>
										</div>
									</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="passwordForm">
						<div class="mb-3">
							<label for="password" class="form-label">비밀번호를
